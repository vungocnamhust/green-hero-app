...
class FONT_CONST {
  static final REGULAR =
      TextStyle(fontWeight: FontWeight.w400, color: COLOR_CONST.BLACK);
  ...
  static final QUIZ_QUESTION_FONT_SIZE = 38.0;
  static final QUIZ_TEXT_FONT_SIZE = 23.0;
  ...
  static final PRIMARY_BTN_TEXT = TextStyle(
      color: COLOR_CONST.BLACK, fontWeight: FontWeight.w700, fontSize: 20);
  static final SECONDARY_BTN_TEXT = TextStyle(
      color: COLOR_CONST.WHITE, fontWeight: FontWeight.normal, fontSize: 18);

  static const String fontFamily = 'Flamante-Round';
}
