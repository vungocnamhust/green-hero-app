...
import 'package:learning_vietnamese/features/learning_vietnamese/presentation/common_widgets/hex_color.dart';

// ignore: camel_case_types
class COLOR_CONST {
  //https://gist.github.com/lopspower/03fb1cc0ac9f32ef38f4

  static final HexColor DEFAULT = new HexColor("#222539");
  static final HexColor SECONDARY = new HexColor("#FAFF00");
  ...
  // LIGHT MODE
  static final Color chat_background = Colors.grey[100];
  static final HexColor light_primary = new HexColor("#2C98F6");
  static final HexColor light_primary_gradient = new HexColor("#77BEFC");
  // static const Color light_accent = Color(0xFF0336FF);
  static const Color light_accent = Color(0xFF0336FF);
  static const Color light_accent_light = Color(0xFF3C54B1);
  static const Color light_accent_dark = Color(0xFF192B74);
  // static const Color light_background = Color(0xFFF4DD45);
  static const Color light_background = Colors.white;
  static const Color dark_background1 = Colors.white10;

  static const Color light_learn_background = Color(0xFFFFF5B8);

  static const Color light_headline6 = Color(0xFF1E1E1E);
  static final Color light_bodyText2 = Colors.grey[400];
  static final Color light_bodyText3 = Colors.grey[600];
  // static const Color light_bodyText2 = Color(0xFF777777);

  // DARK MODE
  static const Color dark_primary = Color(0xFFFFC48E);
  static const Color dark_accent = Color(0xFF707BBB);
  static final HexColor dark_background = new HexColor("#FFFAFA");
}
